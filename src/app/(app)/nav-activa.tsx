 ...
 * (que decide el [+] de la barra inferior) lo resuelve el layout en el servidor y llega por prop; las
 * no-leidas (el numero del icono de Perfil) salen del contador COMPARTIDO de avisos, el mismo que la
 * campana de escritorio, y se refrescan solas.
 */
