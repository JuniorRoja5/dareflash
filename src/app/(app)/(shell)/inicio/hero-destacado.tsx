...
export function HeroDestacado() {
  ...
  return (
    <div className="relative">
      ...
      />
      <div className="df-float mx-auto w-full max-w-[320px] lg:max-w-[560px]">
        {/* Caja 16:9 en escritorio / 9:16 en móvil (regla cerrada) con blurred-fill. */}
        <CajaVideo
          className="df-sheen rounded-sm border border-line shadow-[var(--df-shadow-lg)]"
          overlays={
            <>
